...
h-10 w-10"><RevealIcon w="40" h="40" /></span>
		<div :class="hidePlayer ? 'tw-flex tw-flex-row tw-flex-wrap md:tw-flex-no-wrap lg:tw-flex-no-wrap xl:tw-flex-no-wrap tw-fixed tw-bottom-0 tw-left-0 tw-right-0 tw-z-20 tw-min-h-10 persplayrmaxheightsm sm:max-h-persplayrmaxheight md:max-h-persplayrmaxheight lg:max-h-persplayrmaxheight lg:max-h-persplayrmaxheight min-h-persplayrminheight tw-py-0 tw-px-0 tw-mt-0 tw-mr-0 tw-mb-0 tw-ml-0 tw-bg-no-repeat tw-bg-center tw-bg-cover tw-hidden pp' : 'tw-flex tw-flex-row tw-flex-wrap md:tw-flex-no-wrap lg:tw-flex-no-wrap xl:tw-flex-no-wrap tw-fixed tw-bottom-0 tw-left-0 tw-right-0 tw-z-20 tw-min-h-10 persplayrmaxheightsm sm:max-h-persplayrmaxheight md:max-h-persplayrmaxheight lg:max-h-persplayrmaxheight lg:max-h-persplayrmaxheight min-h-persplayrminheight tw-py-0 tw-px-0 tw-mt-0 tw-mr-0 tw-mb-0 tw-ml-0 tw-bg-no-repeat tw-bg-center tw-bg-cover pp'" :style="'background-image:url('+Songs[presentSongId].cover+'); background-repeat: no-repeat; background-position: center; background-size: cover'">
